...
const PROJECTS = [
  {
    ...
    description: 'A feature-rich Flutter application with word-by-word Tafsir, multiple editions, and GPS-based Qibla calibration. Crafted for an immersive reading experience.',
  ...
  },
  {
    ...
    description: 'A production-grade Python FastAPI backend for autonomous multi-asset crypto trading with real-time Firebase sync, risk management, and live dashboard.',
